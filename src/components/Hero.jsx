...
const Hero = () => {
  return (
    ...
    >
      <div className="bg-white bg-opacity-80 p-6 rounded text-center md:mt-[-3rem] sm:mt-[-2rem] mt-[-1rem]">
        <h1 className="lg:text-5xl md:text-5xl text-3xl font-bold mb-4 text-[#001AA4]">Kokybė</h1>
        <p className="lg:text-3xl mb-8 text-[#001AA4]">
